...
static NSString * const kConsumerKey       = @"M3Z7FnwoTUPbhcl7O92bEw";
static NSString * const kConsumerSecret    = @"YhehU_ik0zKB84c3r1g7VlaxhQ8";
static NSString * const kToken             = @"VMKgIAyZFW2AF1CQ_GW_3qaCxsS3LHUj";
static NSString * const kTokenSecret       = @"9dfGC-nfwaHYVaF493cg1xidJcU";
